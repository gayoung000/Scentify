...
import EditOnlyScent from '../../feature/Home/edit/EditOnlyScent.tsx';
...
const Home = () => {
  return (
    <Routes>
      ...
      <Route path="/edit/capsule/defaultscent" element={<EditDefaultScent />} />
      <Route path="/edit/defaultscent" element={<EditOnlyScent />} />
    </Routes>
  );
};

...
const scentImages = [
  {
    ...
    alt: "Lemon",
    description: `레몬 향은 상쾌하고 톡 쏘는 시트러스 향으로 공간에 활기를 불어넣습니다.
상큼한 향이 기분을 전환시키고 에너지를 충전하는 데 효과적입니다.
...
거실: 차분하고 고요한 환경 조성.`,
  },
  {
    ...
    alt: "Peppermint",
    description: `페퍼민트 향은 청량한 민트와 약간의 허브 느낌이 어우러진 상쾌한 향으로, 활력을 제공합니다.
머리를 맑게 하고 피로감을 해소하며, 상쾌한 에너지를 선사합니다.
...
거실: 활력과 상쾌함을 더해 활기찬 분위기 연출.`,
  },
  {
    ...
    alt: "White Musk",
    description: `화이트 머스크 향은 깨끗하고 부드러운 파우더리 향으로, 공간에 포근함과 따뜻함을 더합니다.
잔잔하고 은은한 향이 오래 지속되어 편안한 환경을 만들어줍니다.
